...
The architecture research previously published at this URL is preserved as the
[historical workflow consolidation plan](../../architecture/workflow-consolidation-plan-historical.md).
[ADR-030](../../architecture/adr/030-single-graph-execution-engine.md) records the current
engine migration; the BFS streaming path remains pending until its final deletion step lands.
