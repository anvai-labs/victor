...
> **Historical consolidation plan.** This is the earlier design/research snapshot formerly
> published at `guides/workflow-development/examples.md`. Its source paths, diagrams and
> proposed implementation steps are retained as historical evidence. Use
> [ADR-030](adr/030-single-graph-execution-engine.md) for the active engine consolidation
> decision and the [workflow examples index](../guides/workflow-development/examples.md)
