...
| EVR-6 | Online per-turn auditor (prefix-only continue/alarm) — FEP-0008 Phase C — **Shipped opt-in; offline HTIR-oracle gate shipped, real-distribution evidence pending; default OFF** | feature | P1 | M | edge model | AgentForesight `2605.08715` |
