...
| EVR-6 | Online per-turn auditor (prefix-only continue/alarm) — FEP-0008 Phase C — **Shipped opt-in; offline HTIR-oracle gate + digest-pinned producer + real-run review-pack exporter/finalizer shipped, independent review/frozen pack pending; default OFF** | feature | P1 | M | edge model | AgentForesight `2605.08715` |
