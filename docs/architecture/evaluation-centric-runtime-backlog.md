...
| EVR-6 | Online per-turn auditor (prefix-only continue/alarm) — FEP-0008 Phase C — **Shipped opt-in; real-distribution attempt 1 HOLD (2026-09-04), default OFF** ([result](evr6-auditor-results-2026-09-04.md)) | feature | P1 | M | edge model | AgentForesight `2605.08715` |
