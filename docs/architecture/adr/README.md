...
| [ADR-023](023-multi-agent-team-durability.md) | Multi-agent team durability (checkpoint/interrupt/per-member stream) | Proposed | Shipped incrementally 2026-07-30→08-01 (revisions 1.1–1.11): durable checkpoint/resume + per-member streaming lanes across all six formations; durable member pause for SEQUENTIAL/PIPELINE/PARALLEL (HIERARCHICAL pause + per-specialist partial resume in flight); non-team chat continuation deferred; FEP-0028 acceptance pending (TD-25) | 2026-07-29 |
