...
| [ADR-020](020-interactive-terminal-tui.md) | Interactive terminal TUI (Textual) as a first-class surface | Accepted | Partial — v1 shipped 2026-07-30 (`victor tui`, opt-in; TD-22) incl. unified diff pane; theme variants pending | 2026-07-29 |
