...
"""OpenRouter policy over Victor's shared OpenAI-compatible adapter."""
...
class OpenRouterProvider(SandhiOpenAICompatPolicy):
    """OpenRouter provider with declarative static policy and shared wire behavior."""

    CONFIG_KEY = "openrouter"


__all__ = ["DEFAULT_BASE_URL", "OPENROUTER_MODELS", "OpenRouterProvider"]
